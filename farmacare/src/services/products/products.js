class ProductsService {
    ...
    constructor() {
        this.productsList = [
            ...
            { id: 4, name: "Creama hidratante", price: 8500, pathImg: "src/assets/img/cremaParaManos.png", idCategory: 1 },
            ...
            { id: 8, name: "Crema nivea", price: 3000, pathImg: "src/assets/img/crema.png", idCategory: 1 }
        ]
